  ...
  <div class="row">
    ...
    <section class="flat-row flat-member-single padding-v1">
          ...
          <div class="member-single">
            <div class="col-md-9">
              ...
              <div class="col-md-3">
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <span class="text-center"><h3 class="panel-title" >Ubah Foto </h3></span>
                  </div>
              ...
              <div class="col-md-9">
                ...
                <div class="panel panel-info">
                  <div class="panel-heading">
                    <span class="text-center"><h3 class="panel-title" >Biodata Anda </h3></span>
                  </div>
                  <div class="panel-body">
      ...
      <td>
        ...
        <?php
        echo form_dropdown('agama', array(
          '~ Pilih Agama ~',
          'Islam' => 'Islam', 
          'Kristen' => 'Kristen', 
          'Katholik' => 'Katholik', 
          'Hindu' => 'Hindu', 
          'Budha' => 'Budha'), 
        $qu['agama'], "class='form-control'");
        ?> 
      </td>
    </tr>

    <tr><td><b>Profesi :</b></td>
    <td>
      <input type="text-area" class="form-control" id="profesi" name="profesi" value="<?php echo $qu['profesi']; ?>">
      <p>ex : (Mahasiswa, Buruh, Petani, Staff IT, Teller, CS, dsb)</p>
    </td>
  </tr>
...
<td>
  ...
  <p>ex : (Noroyudan RT 11 RW 06, Ds. Keprabon, Kec. Polanharjo)</p>
</td>
</tr>
...
<div class="col-md-3">
  <div class="panel panel-info">
    <div class="panel-heading">
      <span class="text-center"><h3 class="panel-title" >Ubah Password</h3></span>
    </div>
    <div class="panel-body">
  ...
  <div class="panel panel-danger">
    ...
    <div class="panel-body">
     ...
     <a href="https://www.dropbox.com/home?preview=Alumni-SMANSARI.apk" target="_blank">Alumni-SMANSARI.apk</a>
   </div>
 </div>
</div>          
</div>
