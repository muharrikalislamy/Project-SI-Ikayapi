...
<div class="modal fade" id="modal_form" role="dialog">
    <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-5">asrama :</label>
                        <div class="col-md-3">
     ...
     <div class="form-group">
        <label class="control-label col-md-5">Profesi :</label>
        <div class="col-md-3">
 ...
 <div class="form-group">
    ...
    <div class="col-md-3">
     <input name="tempat_lahir" class="form-control" type="text" disabled="">
     <span class="help-block"></span>
 </div>
</div>
<div class="form-group">
    ...
    <div class="col-md-3">
     <input name="tanggal_lahir" class="form-control" type="text" disabled="">
     <span class="help-block"></span>
 </div>
</div>
<div class="form-group">
