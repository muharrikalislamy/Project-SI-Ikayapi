                        ...
                        <div class="col-md-12">
                            <nav class="navbar menu-top">
                                <ul class="menu"> 
                                    ...
                                    <li class="home"><a target="_blank">Respon Cepat : 08XXXXXXXXXX</a></li>
                            ...
                            <div class="navbar-right topnav-sidebar">
                                <ul class="m">
                                    ...
                                    <?php if ($this->session->userdata('id')): ?>
                                        ...
                                        <li class="textwidget">
                                            <a href="<?php echo site_url('login/logout'); ?>" onclick="return confirm('Apakah Anda Yakin Ingin Keluar ?');"><i class="fa fa-sign-out"> Logout</i></a>
                                        </li>
                                    <?php else: ?>
                                        <li class="textwidget"><a href="<?php echo site_url('frontend/login'); ?>"><i class="fa fa-lock"> Login</i></a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                            ...
                            <nav id="mainnav" class="mainnav">
                                <ul class="menu"> 
                                    <li><a href='<?php echo site_url(''); ?>'>Home
                                        <span class="menu-description">Alumni IKAYAPI</span></a>
                                    </li>
                                    
                                    <li><a class="dropdown-toggle" data-toggle="dropdown" href='#'>Tentang Kami
                                        <span class="menu-description">Alumni IKAYAPI</span></a>
                                        <ul class="submenu"> 
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpage'); ?>">Profil Hubungan Alumni</a></li>
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpageHumas'); ?>">Biro Humas dan Networking</a></li>
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpageSosial'); ?>">Biro Sosial</a></li>
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpagePendidikan'); ?>">Biro Pendidikan</a></li>
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpageKaderisasi'); ?>">Biro Kaderisasi</a></li>
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpageWazis'); ?>">Biro Wazis</a></li>
                                            <li class="blue"><a href="<?php echo site_url('frontend/viewpageDakwah'); ?>">Biro Dakwah</a></li>
                                        </ul>
                                    </li>
