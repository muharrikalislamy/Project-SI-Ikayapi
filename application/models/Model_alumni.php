...
class Model_alumni extends CI_model {
	...
	var $table = 'alumni';
	var $column_order = array(null, 'username','nama_lengkap','jenis_kelamin','id_asrama','telp','tahun_lulus'); //set column field database for datatable orderable
	var $column_search = array('username','nama_lengkap','jenis_kelamin','id_asrama','telp','tahun_lulus'); //set column field database for datatable searchable 
